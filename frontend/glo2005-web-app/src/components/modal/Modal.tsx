...
const Modal: React.FC<Props> = ({ isOpen, toggleOpen, children }) => {
  ...
  return createPortal(
    <div className="modal-bg fixed top-0 left-0 w-screen h-screen flex justify-center items-center" onClick={toggleOpen}>
      <div className="modal relative bg-white p-10 rounded-lg drop-shadow-xl flex-col" onClick={e => e.stopPropagation()}>
